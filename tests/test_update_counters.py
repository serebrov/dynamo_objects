...
class UpdateCountersTest(BaseDynamoTest):
    ...
    def setUp(self):
        ...
        self.customer = Customer(customer_id='CUSTOMER1', age=22)
    ...
    def test_counter(self):
        self.table.update_counter('CUSTOMER1', 22, thanks_count=1)
        customer = self.table.get('CUSTOMER1', 22)
        self.assertEquals(1, customer.thanks_count)

    def test_counter_by_ten(self):
        self.table.update_counter('CUSTOMER1', 22, thanks_count=5)
        customer = self.table.get('CUSTOMER1', 22)
